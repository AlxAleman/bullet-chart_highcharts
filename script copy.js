document.addEventListener("DOMContentLoaded", function (event) {
 ...
 - ${i}: ${e}`),
  ...
  Highcharts.chart("container1", {
    title: {
      text: "Company’s revenue growth vs. All company’s revenue average",
      style: {
        color: "#000000",
        fontWeight: "bold",
        fontSize: "9px"
  ...
  Highcharts.chart("container2", {
    title: {
      text: "Company’s revenue growth vs. revenue growth of similar industry and same age bucket companies",
      style: {
        color: "#000000",
        fontWeight: "bold",
        fontSize: "9px"
  ...
  Highcharts.chart("container3", {
    title: {
      text: "Company’s revenue growth vs. revenue growth of similar industry companies.",
      style: {
        color: "#000000",
        fontWeight: "bold",
        fontSize: "9px"
